    ...
    <div class={styles.wrapper}>
      ...
      <div class={styles.card}>
        ...
        <pre class={styles.codeBlock}>
          {props.data ? JSON.stringify(props.data, null, 2) : "loading server metrics..."}
        </pre>
      </div>

      <div class={styles.footer}>
        edit <code class={styles.inlineCode}>src/features/welcome-hero/components/WelcomeHero.tsx/jsx</code> to begin.
      </div>
    </div>
  );
}
