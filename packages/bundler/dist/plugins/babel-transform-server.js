            ...
            Program: {
                ...
                exit(path, state) {
                    if (state.hasRunOnServer) {
                        const importDeclaration = t.importDeclaration([t.importSpecifier(t.identifier("$$executeClientRpc"), t.identifier("$$executeClientRpc"))], t.stringLiteral("@anaemia/core"));
                ...
                if (t.isIdentifier(path.node.callee) && path.node.callee.name === "runOnServer") {
                    ...
                    path.replaceWith(t.callExpression(t.arrowFunctionExpression([], t.blockStatement([
                        ...
                        t.expressionStatement(t.assignmentExpression("=", t.memberExpression(t.identifier("_rpc"), t.identifier("readHydrationCache")), t.arrowFunctionExpression([t.identifier("sourceArg")], t.blockStatement([
                            t.variableDeclaration("const", [
                                t.variableDeclarator(t.identifier("__el"), t.callExpression(t.memberExpression(t.identifier("document"), t.identifier("getElementById")), [t.stringLiteral("__ANAEMIA_DATA__")]))
                            ]),
                            t.ifStatement(t.unaryExpression("!", t.identifier("__el")), t.returnStatement(t.identifier("undefined"))),
                            t.tryStatement(t.blockStatement([
                                t.variableDeclaration("const", [
                                    t.variableDeclarator(t.identifier("__data"), t.callExpression(t.memberExpression(t.identifier("JSON"), t.identifier("parse")), [t.memberExpression(t.identifier("__el"), t.identifier("textContent"))]))
                                ]),
                                t.variableDeclaration("const", [
                                    t.variableDeclarator(t.identifier("__cache"), t.optionalMemberExpression(t.memberExpression(t.identifier("__data"), t.identifier("__SERVER_FUNCTION_DATA__")), t.stringLiteral(functionHash), true, true))
                                ]),
                                t.ifStatement(t.unaryExpression("!", t.identifier("__cache")), t.returnStatement(t.identifier("undefined"))),
                                t.returnStatement(t.memberExpression(t.identifier("__cache"), t.callExpression(t.memberExpression(t.identifier("JSON"), t.identifier("stringify")), [t.arrayExpression([t.identifier("sourceArg")])]), true))
                            ]), t.catchClause(t.identifier("_"), t.blockStatement([t.returnStatement(t.identifier("undefined"))])))
                        ])))),
