...
export function WelcomeHero(props: WelcomeHeroProps) {
  return (
    <div class={styles.wrapper}>
      ...
      <p class={styles.subtitle}>a high-performance, opinionated SolidJS SSR framework that allows you to ship huge projects fast and maintain them!</p>
      ...
      <div class={styles.card}>
        ...
        <pre class={styles.codeBlock}>{props.data ? JSON.stringify(props.data, null, 2) : "loading server metrics..."}</pre>
      </div>
